...
c Last revision: 9/30/00  HFL
	...
	subroutine io_init_pl(infile,lclose,iflgchk,nbod,npl,mass,xh,yh,
...
c Read number of planets
	read(7,*) nbod,npl
        ...
        if(nbod.gt.NPLMAX) then
           ...
           write(*,*) '   The number of permanent planets,',npl,','
	...
	if (npl.gt.nbod) then
	   write(*,*) ' SWIFT ERROR: in io_init_pl: '
	   write(*,*) ' The number of massive bodies, ',nbod,', '
	   write(*,*) ' cannot be larger than the number of '
	   write(*,*) ' massive solar system bodies, ',npl
	endif
